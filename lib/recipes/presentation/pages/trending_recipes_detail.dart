...
class TrendingRecipeDetailScreen extends StatelessWidget {
  const TrendingRecipeDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BaseScreen(
      appBar: const RecipeAppBarDetail(title: "Trending Recipes"),
